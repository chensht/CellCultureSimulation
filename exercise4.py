...
with open("exercise4.csv", 'w') as file:
    ...
    for genome in genomes:
        ...
        for array in array_of_variables:  # creating a meta graph of all three graphs of parameters per error rate
            graph_x = np.array(error_rates)
            graph_y = np.array(array)
        ...
        plt.savefig("exercise4_5A_{}.png".format(genome.name))  # saving it in a file
        plt.show()  # showing it
        ...
        plt.savefig("exercise4_5B1_{}.png".format(genome.name))  # saving it in file
        plt.show()  # showing it
        plt.clf()  # for the terminal
        ...
        plt.savefig("exercise4_5B2_{}.png".format(genome.name))  # saving it in a file
